...
// and assuming movement is from head towards last cylinder then backwards.
#include<stdio.h>
#include <stdlib.h>
#include <stdbool.h>
#include <limits.h>
...
int main(){
    ...
    time += (cylinder-1 - head1);
    time += (cylinder-1-head);
    head1 = head;
    ...
    total_cylinder_movement += 2*((cylinder-1) - head);
    total_cylinder_movement += (head - req[0].a);
